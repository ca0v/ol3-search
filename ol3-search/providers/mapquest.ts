...
const SampleResponse = [
	{
		...
		display_name:
			"Los Angeles International Airport, Service road S, Westchester, Playa del Rey, Los Angeles, Los Angeles County, California, 90245, United States of America",
		class: "aeroway",
		type: "aerodrome",
		importance: 0.50388163735627,
		icon:
			"http://ip-10-98-174-147.mq-us-east-1.ec2.aolcloud.net:8000/nominatim/v1/images/mapicons/transport_airport2.p.20.png",
		address: {
